---
title: "Sophistry: When the Appearance of Correctness Hides a Substituted Connection | Configism"
description: "Sophistry preserves the appearance of correctness after the real connection between words, grounds, and conclusion has been substituted. This article shows where that substitution happens and why logic is the strongest anti-sophistic means."
linkTitle: "Sophistry"
type: docs
...
A person asks about one thing – and receives an answer about another.\
A word means one thing at the beginning – and something else in the conclusion.\
An example is presented as proof.\
An assumption is presented as fact.\
An emotion is presented as a ground.\
An evaluation is presented as a description.\
A headline gives the conclusion before the reader has seen the event itself.

In the logical sense, sophistry is **the substitution of a defined connection while preserving the appearance of that connection**.

More simply: an argument, speech, or explanation still looks as if everything is connected correctly, but the very place that had to hold the transition from word to meaning, from question to answer, from ground to conclusion, has already been changed.
...
**The thesis.**\
A weaker, cruder, or more convenient thought is attributed to the opponent, and then that substituted thought is refuted.

**The ground.**\
The conclusion is presented as if it has been proven, but in reality it rests on emotion, authority, an example, an assumption, or repetition.

**The rule of verification.**\
At first, the discussion required proof, but suddenly “obviousness”, “common sense”, “everyone knows”, or “experts say so” becomes enough.

**The strength of the claim.**\
A possibility begins to sound like a fact. A version becomes a conclusion. An assumption becomes knowledge. Partial correctness becomes complete correctness.

**The scale.**\
One case is presented as a general rule. A local problem becomes proof about the entire system. Personal experience becomes a law for everyone.

**The cause.**\
Something that happened after an event, or next to it, is presented as what truly caused it.

**The consequence.**\
A possible, desired, or frightening result is presented as if it truly follows from the action. The conclusion about the result becomes stronger than the grounds allow.

**The frame of presentation.**\
The way a fact is shown begins to look like the fact itself. A person accepts not only the event, but also a ready-made way of reading it.
...
**Sophistry may be intentional, may arise as an unintentional effect of weak verification, or may be built into the very way of speaking. Intention defines responsibility, but it does not always cancel the substitution itself.**
...
This creates a double path.

Language can help one see the truth: reveal the ground, clarify meaning, defend the weaker side, make the complex understandable.
...
## What Sophistry Is Not
Sophistry must not be confused with any strong use of language.

Rhetoric itself is not sophistry. Rhetoric works with persuasion. It can serve truth: make what matters visible, help the weaker side be heard, explain the complex, gather attention around a real problem.

Dispute itself is not sophistry. People can argue honestly, even sharply. The struggle of positions does not yet mean substitution.

Repetition itself is not sophistry. Repetition can help hold the main thought. But it becomes a problem when it replaces the ground and creates a feeling of truth only through familiarity.

An example itself is not sophistry. An example can explain something complex. But it becomes a problem when it is presented as proof of a general rule without an additional ground.

Simplification itself is not sophistry. Without simplification, it is impossible to explain complex things. But simplification is honest only when it preserves the main transition or openly shows that part of the complexity has been left out. Sophistry begins when simplification removes an important condition but presents the conclusion as if nothing has been lost.

A strong phrase itself is not sophistry. It becomes sophistic when the strength of the phrase makes the conclusion more persuasive than the grounds allow.

Verification is not sophistry either. A question, clarification, doubt, or demand to show the ground is not an attack on language. It is a way to prevent language from substituting the subject.
...
“Clarification” may begin as an attempt to understand and end as sabotage.\
“Possible” may quietly turn into “this is how it is”.\
“Some” may sound as if it means “all”.\
“Experts say” may replace the question of what exactly has been proven.

Metaphor can also become sophistic. It may help one see a similarity, but it does not prove that things are the same. Analogy may open a direction of thought, but it does not cancel difference. A hint may introduce suspicion without taking responsibility for a direct claim.

At this level, sophistry turns into pseudoknowledge.

A person may think something. Then they may believe it. Then they may begin to defend it as if it has been proven.

A version begins to sound like a fact.\
An assumption – like a conclusion.\
An emotion – like proof.\
A familiar phrase – like understanding.\
Group agreement – like truth.\
An authoritative remark – like sufficient ground.\
A media frame – like reality itself.

The ethical problem is not only that a person may accept a false thought. The deeper problem is that language creates the impression that verification has already happened or is no longer needed. Then a person acts, evaluates others, votes, condemns, justifies, or defends a position on the basis of a conclusion whose strength has been quietly inflated.
...
In law, sophistry works through proof, procedure, norm, and interpretation. “Not proven” can be presented as “did not happen”. “Possible” as a full alternative version. Procedure as a way not to see the subject. Legality as justice. Moral pressure as a substitute for proof.
...
It gives a vivid example instead of a sufficient picture.\
It creates a story in which there is already a culprit, a victim, a cause, and an ending.

At the social level, one substitution can be repeated for so long that it stops looking like a substitution. It becomes a linguistic habit.

Criticism automatically becomes attack.\
Disagreement – hostility.\
Clarification – sabotage.\
Control – security.\
Group agreement – knowledge.\
Correct words – proof of correctness.
...
“I was not wrong; I was misunderstood”.\
“This is not a weakness of the argument; it is the complexity of the topic”.\
...
Does the answer truly answer it, or does it move to another question?

What word holds the main meaning?\
Has its meaning changed along the way?

What is presented as the ground?\
Is it a fact, proof, example, authority, emotion, assumption, repetition, or group agreement?

Is the conclusion stronger than the ground allows?\
Has a possibility been turned into a fact, a version into knowledge, partial correctness into complete correctness?

Is an example being presented as proof?\
One case may explain, but it does not always prove a general rule.

Is emotion being presented as a ground?\
Fear, anger, shame, or sympathy may matter, but they do not prove the conclusion by themselves.

Is the frame being presented as fact?\
The way an event was shown is not always the event itself.

Has simplification removed an important condition?\
If the condition has been removed, but the conclusion is presented as if nothing has been lost, this is already dangerous.

In the shortest form, verification comes down to three steps:

What is being claimed?\
What does it rest on?\
Does this exact conclusion truly follow from it?

This is the minimal anti-sophistic formula: **thesis → ground → transition.**
...
“Freedom” for some means autonomy, for others – chaos.\
“Security” for some means protection, for others – control.\
“Justice” for some means responsibility, for others – revenge, for others – procedure.\
“Proof” for some means a verified transition, for others – an authoritative phrase, for others – group agreement.\
“Criticism” for some means verification, for others – aggression.\
“Error” for some leads to correction, for others – to punishment or humiliation.
...
Where is fact, and where is evaluation?\
Where is assumption, and where is conclusion?\
What question was actually asked?\
What follows from what?\
Where does explanation end and justification begin?\
Where is criticism, and where is attack?
...
Which question became another?\
Which assumption was presented as fact?\
